...
public class Account {
    ...
    private Money balance; // Référence réassignée, mais l'objet Money lui-même est immuable

    public Account(UUID id, PhoneNumber phoneNumber, Money initialBalance) {
        this.id = id;
        this.phoneNumber = phoneNumber;
        // Le Money valide déjà ses propres règles dans son constructeur
    ...
    public void debiter(Money montant) {
        // Vérification métier intégrée à l'entité
    ...
    public void transfererVers(Account destinataire, Money montant) {
        // Pré-validation pour garantir l'atomicité conceptuelle
    ...
    // Accesseurs en lecture seule uniquement
